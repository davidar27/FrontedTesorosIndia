...
export function EntrepreneurCard({ item, onEdit, onDelete, onView }: EntrepreneurCardProps) {
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group animate-fade-in-up">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="text-center p-3 bg-green-50 rounded-lg">
                    <p className="text-2xl font-bold text-primary">{item.farms}</p>
                    <p className="text-xs text-gray-600">Fincas</p>
                </div>
                <div className="text-center p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm font-semibold text-blue-600">{item.joinDate}</p>
