...
export function CategoryCard({ item, onEdit, onDelete, onView }: CategoryCardProps) {
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group animate-fade-in-up">
            ...
            <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span className="text-sm">{item.productsCount}</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="text-center p-3 bg-green-50 rounded-lg">
                    <p className="text-2xl font-bold text-primary">{item.color}</p>
